                    ...
                    <div className="hidden sm:flex items-center gap-4 lg:gap-8 text-slate-600">
                        ...
                        {!isSignedIn && (
                            <div className="flex gap-2">
                                <button onClick={handleLoginClick} className="px-5 py-2 hover:bg-slate-100 transition text-slate-700 rounded-full font-medium">
                                    Login
                                </button>
                                <button onClick={() => openSignUp()} className="px-6 py-2 bg-indigo-500 hover:bg-indigo-600 transition text-white rounded-full">
                                    Sign Up
                                </button>
                            </div>
                        )}
