            ...
            <div className="mx-6">
                <div className="flex items-center justify-between max-w-7xl mx-auto py-1.5 transition-all">
                    ...
                    <div className="hidden sm:flex items-center gap-3 lg:gap-5 text-sm text-slate-600">
                        ...
                        {!isSignedIn && (
                            <div className="flex gap-1 items-center">
                                <button onClick={handleLoginClick} className="px-3 py-1 text-sm hover:bg-slate-100 transition text-slate-700 rounded-full font-medium whitespace-nowrap">
                                    Login
                                </button>
                    ...
                    <div className="sm:hidden flex items-center gap-3">
                        ...
                        {!isSignedIn && (
                            <button onClick={handleLoginClick} className="px-3 py-1.5 hover:bg-slate-100 text-sm transition text-slate-700 rounded-full font-medium">
                                Login
                            </button>
                        )}
                        {isSignedIn && (
