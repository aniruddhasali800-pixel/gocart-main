...
const Footer = () => {
    ...
    const linkSections = [
        ...
        },
        {
            title: "CONTACT",
            links: [
                { text: "9960752618", path: '/', icon: PhoneIcon },
                { text: "binarycomputersndbr@gmail.com", path: '/', icon: MailIcon },
                { text: "22,1st Foor Saiachana Plaza, Bus Stand, Nandurbar-425412", path: '/', icon: MapPinIcon }
            ]
        }
    ];
